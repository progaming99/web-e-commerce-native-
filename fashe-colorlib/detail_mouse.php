...
// query ambil data
$ambil = $koneksi->query("SELECT * FROM mouse WHERE id_mouse='$id_mouse'");
				...
				<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							...
							<li>
								<a href="about.php">Tentang Kita</a>
							</li>
	...
	<div class="container bgwhite p-t-35 p-b-80">
		<div class="flex-w flex-sb">
				...
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<div class="slick3">
							...
							<div class="wrap-pic-w">
								<img src="foto_mouse/<?php echo $detail["foto_mouse"]; ?>" alt="">
							</div>
			...
			<div class="w-size14 p-t-30 respon5">
				<h4 class="product-detail-name m-text16 p-b-13"><?php echo $detail["nama_mouse"] ?>
				</h4>

				<span class="m-text17">
					Rp. <?php echo number_format($detail["harga_mouse"]); ?>
				</span>
				<br><br>
				<h5>Stok : <?php echo $detail['stok_mouse'] ?></h5>
				<!--  -->
				<form method="post">
					...
					<div class="flex-r-m flex-w p-t-10">
						<div class="w-size16 flex-m flex-w">
							<div class="flex-w bo5 of-hidden m-r-22 m-t-10 m-b-10">
								...
								<input class="size8 m-text18 t-center num-product" type="number" name="jumlah" value="1" max="<?php echo $detail['stok_mouse'] ?>">
							...
							<div class=" size9 trans-0-4 m-t-10 m-b-10">
								<!-- Button -->
								<button class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" name="beli">
									Tambah ke keranjang
								</button>
							</div>
						</div>
			...
			<?php
			//jika di tekan tombol beli
			if (isset($_POST["beli"]))
			{
				//mendapatkan jumlah yang di inputkan
				$jumlah = $_POST["jumlah"];
				// masukanndi keranjang belanja
				$_SESSION["keranjang"][$id_mouse] = $jumlah;
