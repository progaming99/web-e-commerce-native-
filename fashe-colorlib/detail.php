	...
	<div class="container bgwhite p-t-35 p-b-80">
		<div class="flex-w flex-sb">
			...
			<div class="w-size14 p-t-30 respon5">
				<h4 class="product-detail-name m-text16 p-b-13"><?php echo $detail["nama_produk"] ?>
				</h4>
				...
				<br>
				<h5>Berat : <?php echo $detail['berat'] ?> Gr</h5>
				<!--  -->
				<form method="post">
					...
					<div class="flex-r-m flex-w p-t-10">
						<div class="w-size16 flex-m flex-w">
							<div class="flex-w bo5 of-hidden m-r-22 m-t-10 m-b-10">
								...
								<input class="size8 m-text18 t-center num-product" type="number" name="jumlah" value="1" max="<?php echo $detail['stok_produk'] ?>">
			...
			?>
				...
				<tr class="techSpecRow"><td class="techSpecTD1">Brand :</td><td class="techSpecTD2"><?php echo $detail["brand"]?> </td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Model :</td><td class="techSpecTD2"><?php echo $detail["model"]?> </td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Jenis :</td><td class="techSpecTD2"> <?php echo $detail["jenis"]?> </td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Kecepatan :</td><td class="techSpecTD2"> <?php echo $detail["kecepatan"]?> </td></tr>
				</tbody>
				</table>
