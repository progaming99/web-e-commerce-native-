...
{
	echo "<script>alert('ddddddddddd');</script>";
...
<!-------------------------------------------------------------------- Menu Mobile --------------------------------------------------->
	...
	if (isset($_POST["kirim"]))
	{
		...
		//update data pembelian dari pending menjadi delivered
		$koneksi->query("UPDATE pembelian SET status_pembelian='Pembayaran Sukses'
