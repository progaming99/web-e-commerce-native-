					...
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<div class="search-product pos-relative bo4 of-hidden">
							...
							<button class="flex-c-m size5 ab-r-m color2 color0-hov trans-0-4">
								<i class="fs-12 fa fa-search" aria-hidden="true" name="cari"></i>
							</button>
						</form>			
...
<!------------------------------------------------------ Product1 --------------------------------------------------------------------->
					<div class="row">
						...
						<?php while($permouse =$ambil->fetch_assoc()){ ?>
						...
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							...
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative">
									...
									<img src="foto_mouse/<?php echo $permouse['foto_mouse']; ?>" alt="">

									<div class="block2-overlay trans-0-4">
										
<!-------------------------------------------------------- Button -------------------------------------------------->
							<div class="block2-btn-addcart w-size1 trans-0-4">
								<a href="beli.php?id=<?php echo $permouse['id_mouse']; ?>" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4"  >
								Beli
								</a>
							</div>
									</div>
								...
								<div class="block2-txt p-t-20">
									<a href="detail_mouse.php?id=<?php echo $permouse["id_mouse"]; ?>" class="block2-name dis-block s-text3 p-b-5">
										<?php echo $permouse['nama_mouse']; ?>
									</a>

									<span class="block2-price m-text6 p-r-5">
										Rp. <?php echo number_format($permouse['harga_mouse']); ?>
									</span>
								</div>
							</div>
						</div>						
		...
		<?php
							if(isset($_GET['cari'])){
								$cari = $_GET['cari'];
								$permouse = mysql_query("select * from mouse where nama_mouse like '%".$cari."%'");
							}
							else
							{
								$permouse = mysql_query("select * from mouse");
							}
							$no = 1;
							while($permouse =$ambil->fetch_assoc()){
								?>
								<tr>
									<td><?php echo $no++; ?></td>
									<td><?php echo $permouse['nama_mouse']; ?></td>
								</tr>
							<?php } ?>
	</section>
